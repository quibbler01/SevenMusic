...
//      }
    ...
    public synchronized Rect getFramingRect() {
        ...
        if (FRAME_MARGINTOP != -1) {
            ...
            topOffset = (screenResolution.y - FRAME_HEIGHT) / 3;
        }
   ...
   */
    ...
    private boolean flashLightAvailable() {
        return camera != null && previewing && getContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH);
    }
