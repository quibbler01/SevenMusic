 ...
 * 播放器
 */
public class SevenVideoPlayer extends FrameLayout
        implements ISevenVideoPlayer,
    ...
    private SevenTextureView mTextureView;
    private SevenVideoPlayerController mController;
    ...
    public void setController(SevenVideoPlayerController controller) {
    ...
    public void start() {
        ...
        if (mCurrentState == STATE_IDLE) {
            SevenVideoPlayerManager.getInstance().setCurrentSevenVideoPlayer(this);
            initAudioManager();
            initMediaPlayer();
            initTextureView();
            addTextureView();
    ...
    private IMediaPlayer.OnPreparedListener mOnPreparedListener
        ...
        public void onPrepared(IMediaPlayer mp) {
            ...
            if (continueFromLastPosition) {
                long savedPlayPosition = SevenUtil.getSavedPlayPosition(mContext, mUrl);
    ...
    public void enterFullScreen() {
        ...
        ViewGroup contentView = (ViewGroup) SevenUtil.scanForActivity(mContext)
    ...
    public void enterTinyWindow() {
        ...
        LayoutParams params = new LayoutParams(
                (int) (SevenUtil.getScreenWidth(mContext) * 0.6f),
                (int) (SevenUtil.getScreenWidth(mContext) * 0.6f * 9f / 16f));
    ...
    public void release() {
        ...
        if (isPlaying() || isBufferingPlaying() || isBufferingPaused() || isPaused()) {
            SevenUtil.savePlayPosition(mContext, mUrl, getCurrentPosition());
        } else if (isCompleted()) {
