 ...
 * 控制器抽象类
 */
public abstract class SevenVideoPlayerController
        extends FrameLayout implements View.OnTouchListener {

    private Context mContext;
    protected ISevenVideoPlayer mSevenVideoPlayer;
    ...
    public SevenVideoPlayerController(Context context) {
        super(context);
        mContext = context;
     ...
     *                  <ul>
     *                  <li>{@link SevenVideoPlayer#STATE_IDLE}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_PREPARING}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_PREPARED}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_PLAYING}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_PAUSED}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_BUFFERING_PLAYING}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_BUFFERING_PAUSED}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_ERROR}</li>
     *                  <li>{@link SevenVideoPlayer#STATE_COMPLETED}</li>
     *                  </ul>
     */
     ...
     *                 <ul>
     *                 <li>{@link SevenVideoPlayer#MODE_NORMAL}</li>
     *                 <li>{@link SevenVideoPlayer#MODE_FULL_SCREEN}</li>
     *                 <li>{@link SevenVideoPlayer#MODE_TINY_WINDOW}</li>
     *                 </ul>
     */
    ...
    protected void startUpdateProgressTimer() {
        ...
        if (mUpdateProgressTimerTask == null) {
            mUpdateProgressTimerTask = new TimerTask() {
                @Override
                public void run() {
                    SevenVideoPlayerController.this.post(new Runnable() {
                        @Override
                        public void run() {
                            updateProgress();
                        }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (mSevenVideoPlayer.isIdle()
                || mSevenVideoPlayer.isError()
                || mSevenVideoPlayer.isPreparing()
                || mSevenVideoPlayer.isPrepared()
                || mSevenVideoPlayer.isCompleted()) {
            hideChangePosition();
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mNeedChangePosition && !mNeedChangeVolume && !mNeedChangeBrightness) {
                    ...
                    if (absDeltaX >= THRESHOLD) {
                        ...
                        mGestureDownPosition = mSevenVideoPlayer.getCurrentPosition();
                        ...
                        if (mDownX < getWidth() * 0.5f) {
                            ...
                            mGestureDownVolume = mSevenVideoPlayer.getVolume();
                        }
                    }
                }
                ...
                if (mNeedChangeBrightness) {
                    ...
                    WindowManager.LayoutParams params = SevenUtil.scanForActivity(mContext)
            ...
            case MotionEvent.ACTION_UP:
                if (mNeedChangePosition) {
                    mSevenVideoPlayer.seekTo(mNewPosition);
                    hideChangePosition();
